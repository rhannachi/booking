...
export const nextOnErrorMiddleware = (err: ApiError, _req: NextApiRequest, res: NextApiResponse) => {
...
type controllerType = (req: NextApiRequest, res: NextApiResponse<IApiResponse>, next?: NextHandler) => Promise<void>
