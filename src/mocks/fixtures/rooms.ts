...
export const roomsMockResponse: IRoom[] = [
  {
    ...
    address: 'Bicetown Street, New York, NY, 10004',
    numOfBeds: 1,
    guestCapacity: 1,
    internet: true,
    breakfast: true,
  ...
  },
  {
    ...
    address: 'Olympic Dr, Stafford, VS, 22554',
    guestCapacity: 2,
    numOfBeds: 2,
    internet: true,
    breakfast: false,
  ...
  },
  {
    ...
    address: 'Parkway Street, Apple Valley, CA, 92307',
    guestCapacity: 3,
    numOfBeds: 2,
    internet: true,
    breakfast: true,
  ...
  },
  {
    ...
    address: 'Cherry St, Buffalo, NY, 14202',
    guestCapacity: 6,
    numOfBeds: 3,
    internet: true,
    breakfast: true,
  ...
  },
  {
    ...
    description:
      'Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.',
    address: 'Mudlick Road, Yakima, WA, 98902',
    guestCapacity: 2,
    numOfBeds: 1,
    internet: true,
    breakfast: true,
  ...
  },
  {
    ...
    description:
      'Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.',
    address: 'Godfrey Street, Portland, OR, 97205',
    guestCapacity: 2,
    numOfBeds: 2,
    internet: true,
    breakfast: true,
  ...
  },
  {
    ...
    description:
      'Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.',
    address: 'Parrish Avenue, SAINT LOUIS, MO, 63116',
    guestCapacity: 5,
    numOfBeds: 3,
    internet: true,
    breakfast: true,
  ...
  },
  {
    ...
    description:
      'Our largest room with a queen bed and foldable sofa. Comfortably fits 2-3 adults, four adults maximum. Decorated with Irish-themed colors and arts. It has a private bathroom with a shower, equipped with smart TV, mini-fridge, desk, chairs. Enjoy City views at the sitting area by the window. Located on the 3rd floor with no elevator.',
    address: 'Red Hawk Road, Garfield, MN, 56332',
    guestCapacity: 2,
    numOfBeds: 1,
    internet: true,
    breakfast: false,
